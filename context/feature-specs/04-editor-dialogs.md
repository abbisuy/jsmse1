...
The editor-navbar and project-sidebar have already been built as components. use them for the editor home screen.  The editor home screen will have the editor-navbar on the top, a floting project-sidebar and the center of the page. The floating project-sidebar is controlled by the state variable SidebarOpen.
